...
const fs = require("fs")
const { color, bgcolor } = require('./index/color')
...
module.exports = {savefromV2, ChatGpt, searchfilm,getSurah, tafsir, instagram4, capcutdl, instagram3, mediafiredll, cekkuota,tele, instagram2, kodepos, pinterest, igdl, textpro, mediafire, ffstalk, mlstalk, Tiktok,surah, listsurah, ephoto, emoji}
